...
void VL53L4CXSensor::setup() {
  ...
  sensor_instance->VL53L4CX_SetMeasurementTimingBudget(10000);  // Set timing budget to 100ms
  sensor_instance->VL53L4CX_SetDistanceMode(VL53L4CX::LongRange);  // Switch to long-range mode
