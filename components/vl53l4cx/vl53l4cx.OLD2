...
// Inherit from Sensor and I2CDevice
class VL53L4CXSensor : public sensor::Sensor, public i2c::I2CDevice {
 public:
  void setup() override {
    // Initialize the sensor via I2C
    ESP_LOGI("VL53L4CX", "Setting up VL53L4CX sensor...");
  ...
  void update() override {
    ...
    // Publish the distance or NaN if invalid
    if (distance > 0) {
  ...
  uint16_t get_distance() {
    ...
    this->sensor.VL53L4CX_GetMultiRangingData(&ranging_data);
